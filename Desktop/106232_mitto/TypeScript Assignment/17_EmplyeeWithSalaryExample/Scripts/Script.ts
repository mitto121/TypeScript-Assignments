...
{  
    ...
    constructor(public _fname:string,public _lname:string,public _salary:number)
    {
        this.fname=_fname;
        this.lname=_lname;
...
let obj1:Employee=new Employee("Mike","Tyre",25000);
document.write("First Employee "+ obj1.EmployeeTest());

document.write("<br>");
let obj2:Employee=new Employee("Micky","Mouse",50000);
